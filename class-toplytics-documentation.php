...
?>
		...
		<p>Simple PHP examples:</p>
<textarea readonly="readonly" cols="80" rows="8">
...
<textarea readonly="readonly" cols="80" rows="16">
	if ( function_exists( 'toplytics_get_results' ) ) {
		...
		<p>To use your custom template just copy and paste the file `toplytics-template.php` from the toplytics plugin directory to your theme directory, then customize this file.</p><p>The plugin will search first in `toplytics-template.php` file from the theme directory and then will search in the plugin directory, in this case your custom template from the theme structure will be visible first.</p>
<?php
	}
}
